...
<code>nuxt</code>、<code>push</code>、<code>offline-write</code>、<code>entry-resilience</code>、<code>browser-test-harness</code>、<code>examples-browser-e2e</code> 和 <code>release-tools</code> 仍是工作区私有包。前四者属于[可选能力](/guide/optional)；后三者服务于平台测试与治理。
