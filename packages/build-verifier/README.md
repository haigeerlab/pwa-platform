...
Verify PWA Platform build and deployment facts.

Build and release verification primitives used by the Vite adapter and external release systems. It does not fetch production facts itself.
