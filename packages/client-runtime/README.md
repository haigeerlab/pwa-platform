...
Browser registration and update lifecycle for PWA Platform.

Browser lifecycle facade used by the framework bindings. Applications normally use the Vue or React package.
