...
Validated identity, policy, and plan contracts for PWA Platform.

Shared validated contract types and schemas. Applications may import types for configuration; runtime behavior belongs to the host adapter.
