// The shared-origin fixture's root app page script (T7). Registers the root worker at the root's own scope through
// the platform client — the same path a real root app on this topology takes. Mirrors browser-tests/app/src/main.ts.
import "./shell.css";
