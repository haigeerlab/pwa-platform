...
Compile PWA Platform policies into deployment plans.

Policy compiler used by the build integration. Applications should configure the host adapter instead of calling this package directly.
