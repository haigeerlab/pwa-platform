...
日期：2026-09-26。范围：文档站源文件与本地构建；文档站尚未发布。本模块不执行 npm 发布；包发布状态依据独立发布记录核对。
...
- 平台资料：`website/index.md`、`website/guide/updates.md`、`packages/vite/package.json`、`packages/vue/package.json`、`packages/react/package.json`、`spec/update-notice-ui.md` 与 `tasks/update-notice-ui/verification.md`。已发布的 `0.1.0-beta.2`、仍指向 beta.1 的 npm `latest` 与未公开的工作区功能分别表述。
