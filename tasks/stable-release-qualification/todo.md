...
- [ ] T6 核对 `/` 与 `/m/`、缓存拒绝、恢复 worker、CSP 与可选 UI 个性化，修复并复测缺陷
- [ ] T7 将入口恢复包纳入正式分发并完成十包干净候选、审计、pack、独立消费和文档门禁
- [ ] T8 记录发布通道与未取得证据，满足门禁后发布 npm 正式版并读回验证
